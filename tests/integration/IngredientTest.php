...
class IngredientTest extends TestCase {
    ...
    public function testGetIdByNomIngredient()
    {
        // Cas de test avec un nom d'ingrédient existant
        $nom_exist = 'Nom de l\'ingrédient existant';
        $id_exist = $this->ingredientDAO->getIdByNomIngredient($nom_exist);
        $this->assertEquals(1, $id_exist);

        // Cas de test avec un nom d'ingrédient inexistant
        $nom_inexistant = 'Nom de l\'ingrédient inexistant';
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('Aucun ingrédient trouvé avec ce nom');
        $this->ingredientDAO->getIdByNomIngredient($nom_inexistant);
    }
